...
<head>
    ...
    <title>NovaPay DiagTool — beheerterminal (veilig)</title>
...
<div class="breadcrumb">
    <a href="/">Home</a> &rsaquo; A10 &rsaquo; Mishandling of Exceptional Conditions (Veilig)
</div>
...
<div class="container">
    ...
    <div class="terminal-panel">
        <div class="terminal-topbar">
            ...
            <span class="terminal-title">NovaPay DiagTool v2.0 &mdash; Beheerterminal [VEILIG]</span>
        </div>

        <div class="terminal-body">
            <div class="terminal-motd">NovaPay DiagTool v2.0 [secure build]<br>
Verbonden met NovaPay Platform &mdash; Welkom, operator</div>
...
<div class="modal-overlay" id="infoModal">
    <div class="modal">
        ...
        <div class="info-section">
            ...
            <div class="vuln-box">
                <ul>
                    <li><strong>CWE-636 (fail-open):</strong> <code>check auth</code> gooit een paniek maar verleent alsnog toegang &mdash; de paniek wordt afgevangen maar de fout genegeerd</li>
                    ...
                    <li><strong>CWE-391 (fout genegeerd):</strong> <code>pay xyz alice</code> gebruikt <code>amount, _ :=</code> &mdash; de parsefout wordt weggegooid, bedrag wordt €0 en de betaling gaat door</li>
        ...
        <div class="info-section">
            ...
            <div class="safe-box">
                <ul>
                    ...
                    <li><strong>CWE-391 fix:</strong> <code>pay xyz alice</code> controleert de <code>err</code> expliciet en weigert de transactie</li>
