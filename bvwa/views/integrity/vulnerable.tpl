...
<head>
    ...
    <title>bvwa-deploy — deployment pipeline (kwetsbaar)</title>
...
<div class="breadcrumb">
    <a href="/">Home</a> &rsaquo; A08 &rsaquo; Software/Data Integrity Failures (Kwetsbaar)
</div>
...
<div class="container">
    ...
    <div class="terminal-panel">
        <div class="terminal-topbar">
            ...
            <span class="terminal-title">bvwa-deploy v1.0.0 &mdash; CI/CD Deployment Pipeline</span>
        </div>

        <div class="terminal-body">
            <div class="terminal-motd">bvwa-deploy v1.0.0<br>
Verbonden met deploy.bvwa-corp.local &mdash; Welkom, deployer</div>
        ...
        <form method="GET" action="/integrity/vulnerable">
