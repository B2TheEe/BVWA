...
<head>
    ...
    <title>bvwa-bank — overboekingssysteem (kwetsbaar)</title>
...
<div class="breadcrumb">
    <a href="/">Home</a> &rsaquo; A06 &rsaquo; Insecure Design (Kwetsbaar)
</div>
...
<div class="container">
    ...
    <div class="terminal-panel">
        <div class="terminal-topbar">
            ...
            <span class="terminal-title">bvwa-bank v1.0.0 &mdash; Online Overboekingssysteem</span>
        </div>

        <div class="terminal-body">
            <div class="terminal-motd">bvwa-bank v1.0.0<br>
...
<div class="modal-overlay" id="examplesModal">
    <div class="modal">
        ...
        <div class="example-item">
            ...
            door simpelweg een negatief bedrag in te vullen als afschrijving.</p>
        ...
        <div class="example-item">
            ...
            <p>Vlak voor de gedwongen shutdown van Parler scrапten activisten alle
            70 TB aan content door het ontbreken van rate limiting en sequenti&euml;le
            media-ID&rsquo;s &mdash; inclusief verwijderde berichten en GPS-co&ouml;rdinaten.</p>
        ...
        <div class="example-item">
            ...
            <p>Een API-endpoint bij T-Mobile vereiste geen authenticatie voor het ophalen
            van klantgegevens. Door sequenti&euml;le ID&rsquo;s te itereren waren de gegevens
            van 37 miljoen abonnees opvraagbaar &mdash; het achtste datalek in vijf jaar.</p>
...
<div class="modal-overlay" id="infoModal">
    <div class="modal">
        ...
        <div class="info-section">
            ...
            regel code is geschreven. Anders dan implementatiefouten (zoals SQL-injectie) gaat het
            hier om het ontbreken van beveiligingsoverwegingen op architectuurniveau. De oplossing
            is niet een patch, maar een herontwerp.</p>
        </div>
        <hr>
        ...
        <div class="info-section">
            ...
            <div class="vuln-box">
                Het bvwa-bank overboekingssysteem heeft fundamentele <strong>ontwerpfouten</strong>:
                <ul>
                    <li><strong>CWE-840 &mdash; Business Logic Error:</strong>
                        het ontwerp gaat ervan uit dat gebruikers alleen positieve bedragen invoeren.
                        Negatieve bedragen zijn nooit overwogen als misbruikscenario.</li>
                    <li><strong>CWE-841 &mdash; Improper Behavioral Workflow:</strong>
                        het systeem verwerkt transacties zonder eerst te valideren of een overboeking
                        financi&euml;el zinvol is (saldo &ge; bedrag, bedrag &gt; 0).</li>
                    <li><strong>CWE-642 &mdash; External Control of Critical State Data:</strong>
                        het bedrag komt rechtstreeks van de gebruiker zonder server-side sanity check.</li>
                </ul>
            </div>
        </div>
        <hr>
        ...
        <div class="info-section">
            ...
            <div class="safe-box">
                De veilige versie implementeert <strong>secure design principes</strong>:
                <ul>
                    <li><strong>Bedragvalidatie:</strong> server weigert elk bedrag &le; 0</li>
                    <li><strong>Overdraft-check:</strong> transfer wordt geblokkeerd als saldo ontoereikend is</li>
                    <li><strong>Fail-closed:</strong> bij ongeldige input wordt de transactie geweigerd</li>
                    <li><strong>Threat modeling:</strong> misbruikscenario&rsquo;s zijn meegenomen in het ontwerp</li>
                </ul>
            </div>
        </div>
        <hr>
        ...
        <div class="info-section">
            ...
            server-side &mdash; vertrouw nooit op client-side invoer. Documenteer en test
            expliciete misbruikscenario&rsquo;s als onderdeel van het acceptatieproces.</p>
        </div>
    </div>
</div>
